...
battleZonesMap.push(new BattleZone("Bandit Hideout", "7-15", [new ZoneEnemyWeight("Guard Dog", 20), new ZoneEnemyWeight("Bandit Grunt", 5), new ZoneEnemyWeight("Bandit Leader", 1)], "Hideout of fearsome bandits."));
battleZonesMap.push(new BattleZone("Kobold Caves", "12-17", [new ZoneEnemyWeight("Kobold Scout", 50), new ZoneEnemyWeight("Kobold Warrior", 20), new ZoneEnemyWeight("Kobold Shaman", 5)], "A maze of tunnels crawling with pesky kobolds. They're territorial."));
