...
enemyMap.set("Cultist Acolyte", new Enemy("Cultist Acolyte", 46, EnemyDifficulty.easy));
enemyMap.set("Dark Priest", new Enemy("Dark Priest", 48, EnemyDifficulty.medium));
