...
enemyMap.set("Bandit Grunt", new Enemy("Bandit Grunt", 12, EnemyDifficulty.medium));
enemyMap.set("Bandit Leader", new Enemy("Bandit Leader", 15, EnemyDifficulty.hard));
...
enemyMap.set("Kobold Shaman", new Enemy("Kobold Shaman", 17, EnemyDifficulty.hard));
